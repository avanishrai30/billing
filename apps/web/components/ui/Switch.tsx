      ...
      >
        <div className="relative inline-flex items-center">
          <input
            ...
            {...props}
          />
          <div className="w-9 h-5 bg-slate-200 border border-slate-300 peer-checked:bg-blue-700 peer-checked:border-blue-700 rounded-full transition-colors peer-focus-visible:ring-2 peer-focus-visible:ring-blue-500/50" />
