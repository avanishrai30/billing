...
export function ProductTable({
  ...
  if (isLoading) {
    return (
      <div className="bg-[#111827] border border-white/10 rounded-2xl p-6 space-y-4 animate-pulse">
    ...
    <div className="bg-[#111827] border border-white/10 rounded-2xl overflow-hidden shadow-xl">
      <div className="overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="w-[300px]">Product / Label</TableHead>
                ...
                <TableRow key={p.id} className="hover:bg-white/[0.02]">
                  ...
                  <TableCell>
                    <div className="space-y-1 font-mono text-xs">
                      <div className="font-semibold text-sky-400">{p.sku}</div>
                      {p.barcode ? (
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        ...
                        className="p-1.5 rounded-lg text-slate-400 hover:text-sky-400 hover:bg-white/5 transition-colors cursor-pointer"
