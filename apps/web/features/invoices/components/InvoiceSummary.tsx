...
import { Receipt, IndianRupee, Percent, TrendingUp } from 'lucide-react';
import { Skeleton } from '../../../components/ui';
import type { InvoiceSummaryMetrics } from '../types';
...
export function InvoiceSummary({ metrics, isLoading }: InvoiceSummaryProps) {
  if (isLoading) {
    return (
  ...
  const cards = [
    {
      label: 'Total Completed Invoices',
