      ...
      <div className="space-y-3 text-xs">
        ...
        <div className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-300 space-y-1.5">
          ...
          <p className="text-amber-200/90 leading-relaxed">
            Deleting <strong className="text-white">{supplier.name}</strong> ({supplier.contact}) will remove their profile from future purchase invoice entries and product inward selections. All past procurement history will remain safely preserved in the purchase ledger.
          </p>
        </div>
      </div>
    </Dialog>
