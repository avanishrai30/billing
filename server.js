...
app.post('/api/products', verifyJWT, validateBody(productSchema), async (req, res) => {
  ...
  try {
    ...
    const productDoc = {
      ...
      category: prodInput.category || prodInput.categoryId || "Dairy & Ghee",
      categoryId: prodInput.categoryId || prodInput.category || "Dairy & Ghee",
      brand: prodInput.brand || prodInput.brandId || "AIAVRO",
      brandId: prodInput.brandId || prodInput.brand || "AIAVRO",
      supplier: prodInput.supplier || prodInput.supplierId || "Direct Farmer Market",
      supplierId: prodInput.supplierId || prodInput.supplier || "Direct Farmer Market",
      cost: parseFloat(prodInput.cost || prodInput.costPrice) || 0,
      costPrice: parseFloat(prodInput.costPrice || prodInput.cost) || 0,
      price: parseFloat(prodInput.price || prodInput.sellingPrice) || 0,
      sellingPrice: parseFloat(prodInput.sellingPrice || prodInput.price) || 0,
      stock: parseFloat(req.body.stock) || 0,
      reorder: parseFloat(req.body.reorder) || 5,
      maxStock: parseFloat(req.body.maxStock) || 100,
